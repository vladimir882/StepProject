...
$(document).ready(function () {
    ...
    $('.load-more-button').click(function () {
        ...
        // Чекайте 2 секунди, після чого додайте картинки на сторінку
        setTimeout(function () {
            ...
            // Заберіть клас "loading" з кнопки "Load More"
            $('.load-more-button').removeClass('loading');
        }.bind(this), 2000); // Затримка в 2 секунди для імітації завантаження
    });
});
